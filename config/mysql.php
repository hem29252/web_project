<?php
  ...
  class mysql {
    ...
    public function UpdateFiveColumn($con,$table,$column1,$column2,$column3,$column4,$column5,$value1,$value2,$value3,$value4,$value5,$where,$id){
      $sql = "UPDATE $table SET $column1 = '$value1', $column2 = '$value2', $column3 = '$value3' , $column4 = '$value4', $column5 = '$value5' WHERE $where = '$id'";
      $query = $con->query($sql);
      return $query;
    }
